//! Discover OneWire devices on the bus.
//!
//! The bus MUST have a ~5K pullup attached to it. 4k7 works well in my testing.
//!
//! The DS2502 in the lil 3 pin SMD package needs BOTH grounds connected to be discovered.
